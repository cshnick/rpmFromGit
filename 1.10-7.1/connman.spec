...
ln -s ../connman.service %{buildroot}/lib/systemd/system/network.target.wants/connman.service
# << install post
...
/lib/systemd/system/network.target.wants/connman.service
%dir /lib/systemd/system/network.target.wants
/lib/systemd/system/connman-vpn.service
...
%dir %config %{_sysconfdir}/connman
# >> files configs-mer
# << files configs-mer
